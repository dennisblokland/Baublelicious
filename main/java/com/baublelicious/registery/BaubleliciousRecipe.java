...
public abstract class BaubleliciousRecipe {
	...
	public static void init() {
        ...
        GameRegistry.addRecipe(new ItemStack(BaubleliciousItems.ItemFlyingRing), " C ", "FRF"," D ", 'N', Items.nether_star, 'R', BaubleliciousItems.ItemRing, 'D', Items.diamond, 'F', Items.feather, 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1));
        ...
        GameRegistry.addRecipe(new ItemStack(BaubleliciousItems.ItemRing), " G ", "G G"," G ", 'G', Items.gold_nugget);
