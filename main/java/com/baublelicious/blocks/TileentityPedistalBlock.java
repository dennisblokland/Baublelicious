...
public class TileentityPedistalBlock extends BlockContainer {

	private String player;
	public int rotation = 0;

        public TileentityPedistalBlock(int id) {
                super(Material.wood);
                this.setBlockName("PedistalBlock");
		...
		public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) {
			return new TileentityPedistalEntity();
		}
		@Override
