...
public abstract class BaubleliciousRecipe {
  ...
  public static void init() {
    ...
    GameRegistry.addRecipe(new ItemStack(BaubleliciousItems.ItemAmuletGrowth), " A ", "BCB", " S ", 'A', BaubleliciousItems.ItemAmulet, 'S', Blocks.sapling, 'B', new ItemStack(Items.dye, 0, 15), 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 2));
    ...
    GameRegistry.addRecipe(new ItemStack(BaubleliciousItems.ItemNecklaceDiving), " C ", "DAD", " B ", 'B', Items.glass_bottle, 'A', BaubleliciousItems.ItemAmulet, 'D', Items.diamond, 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 2));
