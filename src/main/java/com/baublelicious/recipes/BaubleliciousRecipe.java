...
public class BaubleliciousRecipe {
  public static void init() {
    ...
    GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BaubleliciousItems.ItemAmuletGrowth), " A ", "BCB", " S ", 'A', BaubleliciousItems.ItemAmulet, 'S', "treeSapling", 'B', "dyeWhite", 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1)));
    ...
    GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BaubleliciousItems.ItemNecklaceDiving), " C ", "DAD", " B ", 'B', Items.glass_bottle, 'A', BaubleliciousItems.ItemAmulet, 'D', "gemDiamond", 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1)));
    ...
    GameRegistry.addRecipe(new ItemStack(BaubleliciousItems.ItemsAmuletNightvision), " 2 ", "cac", " n ", 'c', Items.golden_carrot, 'n', new ItemStack(Items.potionitem, 1, 8198), 'a', BaubleliciousItems.ItemAmulet, '2', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1));
