...
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemRing), " G ", "I I", " G ", 'G', "nuggetGold", 'I', "ingotIron");
//       // GameRegistry.addRecipe(new ItemStack(BaubleliciousItems.ItemBelt), " L ", "L L", " L ", 'L', Items.LEATHER);
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemAmulet), " L ", "L L", " I ", 'L', Item, 'I', "ingotIron");
//
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemGrowthPendant), " A ", "BCB", " S ", 'A', BaubleliciousItems.ItemAmulet, 'S', "treeSapling", 'B', "dyeWhite", 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1));
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemBeltWaterWalking), " D ", "LBL", " C ", 'L', Item.WATER_BUCKET, 'B', BaubleliciousItems.ItemBelt, 'D', "gemDiamond", 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1));
...
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemRingOfFlight), " C ", "FRF", " D ", 'N', Item.NETHER_STAR, 'R', BaubleliciousItems.ItemRing, 'D', "gemDiamond", 'F', Items.FEATHER, 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 2));
...
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemDivingAmulet), " C ", "DAD", " B ", 'B', Item.GLASS_BOTTLE, 'A', BaubleliciousItems.ItemAmulet, 'D', "gemDiamond", 'C', new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1));
...
//
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemMagicCore, 1), " R ", "GDG", " R ", 'R', "dustRedstone", 'G', "dustGlowstone", 'D', "gemDiamond");
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 1), " D ", "RGR", " D ", 'R', "dustRedstone", 'G', "blockGold", 'D', "gemDiamond");
//        GameRegistry.addShapedRecipe(new ItemStack(BaubleliciousItems.ItemMagicCore, 1, 2), " G ", "RNR", " G ", 'R', "dustRedstone", 'G', "ingotGold", 'N', Items.NETHER_STAR);
//
//        //blocks
